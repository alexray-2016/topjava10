...
- 2: **тщательно считайте количество обращений в базу на каждый запрос. Особенно при запросах от юзеров, которых очен много! Также на сложность запросов от юзеров, чтобы не положить базу**
